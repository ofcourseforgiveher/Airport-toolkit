yum install wget -y && wget https://raw.githubusercontent.com/ofcourseforgiveher/Airport-toolkit/master/ssr_node_c7.sh && chmod +x ssr_node_c7.sh && ./ssr_node_c7.sh
